...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen max-w-[1600px] mx-auto overflow-x-hidden">
      <input 
        type="file" 
        accept=".json" 
      ...
      {/* Sidebar - Form Entry */}
      <div className="no-print w-full md:w-[400px] lg:w-[450px] bg-white border-r border-gray-200 overflow-y-auto h-screen sticky top-0 z-10 shadow-lg">
        <div className="p-6">
          ...
          <div className="flex flex-col gap-3 mb-8">
            <button
              onClick={handlePrint}
              className="w-full bg-blue-700 hover:bg-blue-800 text-white px-4 py-3 rounded-lg font-bold shadow-md transition-all flex items-center justify-center gap-2"
            >
              Print Filled Form
            </button>
            <button
      ...
      <div className="flex-1 p-4 md:p-12 flex justify-center bg-gray-100 overflow-y-auto">
